...
│   │   │   ├── common/    # GenerateSourceAnnotation + its 9 impls, type params, where, property match, KDoc, naming, target validation, diagnostics
