 ...
 * @see Target
 */
internal fun  me.tbsten.cream.generated.SourceA.toTarget(
 ...
 * val sourceB = SourceB(...)
 * val sourceA = SourceA(...)
 * val target = sourceB.toTarget(sourceA = SourceA(...))
 * ```
 * 
 * # Example: Override property values
 * 
 ...
 * val sourceB = SourceB(...)
 * val sourceA = SourceA(...)
 * val target = sourceB.toTarget(sourceA = SourceA(...), property = value)
 * ```
 * 
 * 
 * @see SourceB
 ...
 * @see Target
 */
internal fun  me.tbsten.cream.generated.SourceB.toTarget(
