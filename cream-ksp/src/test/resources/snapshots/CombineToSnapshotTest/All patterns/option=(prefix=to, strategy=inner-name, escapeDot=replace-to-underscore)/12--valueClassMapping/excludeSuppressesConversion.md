 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.to_Target(sourceB = SourceB(...), id = id)
 * ```
 * 
 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.to_Target(sourceB = SourceB(...), id = id, property = value)
 * ```
 * 
 * 
 * @see SourceA
 ...
 * val sourceB = SourceB(...)
 * val sourceA = SourceA(...)
 * val target = sourceB.to_Target(sourceA = SourceA(...), id = id)
 * ```
 * 
 * # Example: Override property values
 * 
 ...
 * val sourceB = SourceB(...)
 * val sourceA = SourceA(...)
 * val target = sourceB.to_Target(sourceA = SourceA(...), id = id, property = value)
 * ```
 * 
 * 
 * @see SourceB
