 ...
 * ```kt
 * val source = Source(...)
 * val target = source.copyToMiddleTarget(extra = extra)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.copyToMiddleTarget(extra = extra, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
internal fun  me.tbsten.cream.generated.Source.copyToMiddleTarget(
