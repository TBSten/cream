 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Middle_Target(extra = extra)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Middle_Target(extra = extra, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_Middle_Target(
