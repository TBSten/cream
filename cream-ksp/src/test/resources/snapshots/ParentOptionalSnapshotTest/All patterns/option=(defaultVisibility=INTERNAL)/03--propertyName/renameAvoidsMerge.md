...
public sealed interface Source {
  ...
  public data class Failure(
    @ParentOptional(propertyName = "failureMessage")
    public val message: String,
  ) : Source
}
```
 ...
 * 
 * Nullable accessor on [Source] exposing [Source.Success.message].
 * 
...
/**
 * (Auto generate by @[ParentOptional] annotation of [Source.Failure.message])
 * 
 * Nullable accessor on [Source] exposing [Source.Failure.message].
 * 
 * Returns the property value when `this` is such a child, otherwise `null`.
 * 
 * # Example
 ...
 * ```kt
 * val state: Source = /* one of the subtypes */
 * val failureMessage: String? = state.failureMessage
 * ```
 * 
 * 
 * @see Source
 ...
 */
@Suppress("REDUNDANT_ELSE_IN_WHEN")
internal val me.tbsten.cream.generated.Source.failureMessage: String?
    get() = when (this) {
