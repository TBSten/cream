...
@CombineMapping(
  ...
  target = Target::class,
  properties = [CombineMapping.Map(source = "sourceName", target = "targetName")],
  excludes = ["targetName"],
)
 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.copyToTarget(sourceB = SourceB(...), targetName = targetName)
 * ```
 * 
 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.copyToTarget(sourceB = SourceB(...), targetName = targetName, property = value)
 * ```
 * 
 * 
 * @see SourceA
