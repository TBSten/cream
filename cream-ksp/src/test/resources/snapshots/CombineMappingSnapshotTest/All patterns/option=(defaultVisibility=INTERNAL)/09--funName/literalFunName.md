 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.toCombinedModel(sourceB = SourceB(...))
 * ```
 * 
 ...
 * val sourceA = SourceA(...)
 * val sourceB = SourceB(...)
 * val target = sourceA.toCombinedModel(sourceB = SourceB(...), property = value)
 * ```
 * 
 * 
 * @see SourceA
 ...
 * @see Target
 */
internal fun  me.tbsten.cream.generated.SourceA.toCombinedModel(
