 ...
 * val libA = LibA(...)
 * val libB = LibB(...)
 * val target = libA.to_Target(libB = LibB(...))
 * ```
 * 
 ...
 * val libA = LibA(...)
 * val libB = LibB(...)
 * val target = libA.to_Target(libB = LibB(...), property = value)
 * ```
 * 
 * 
 * @see LibA
 ...
 * @see Target
 */
public fun  me.tbsten.cream.generated.LibA.to_Target(
 ...
 * val libB = LibB(...)
 * val libC = LibC(...)
 * val target = libB.to_Target(libC = LibC(...), aProp = aProp)
 * ```
 * 
 * # Example: Override property values
 * 
 ...
 * val libB = LibB(...)
 * val libC = LibC(...)
 * val target = libB.to_Target(libC = LibC(...), aProp = aProp, property = value)
 * ```
 * 
 * 
 * @see LibB
 ...
 * @see Target
 */
public fun  me.tbsten.cream.generated.LibB.to_Target(
