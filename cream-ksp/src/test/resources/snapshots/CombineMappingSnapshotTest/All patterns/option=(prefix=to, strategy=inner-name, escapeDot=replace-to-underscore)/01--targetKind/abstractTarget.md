...
```kt
e: file://<TMPDIR>/Kotlin-Compilation<N>/ksp/sources/kotlin/me/tbsten/cream/generated/CombineMapping__Mapping.kt:35:40 Cannot create an instance of an abstract class.
```
