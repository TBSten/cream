...
/**
 * (Auto generate by @[CopyFrom] annotation of [Source])
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_First_Second_Done()
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_First_Second_Done(property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_First_Second_Done(
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_First_Second_Refreshing(extra = extra)
 * ```
 * 
 * # Example: Override property values
 * 
 * ```kt
 * val source = Source(...)
 * val target = source.to_First_Second_Refreshing(extra = extra, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_First_Second_Refreshing(
    name: String = this.name,
    extra: Int,
