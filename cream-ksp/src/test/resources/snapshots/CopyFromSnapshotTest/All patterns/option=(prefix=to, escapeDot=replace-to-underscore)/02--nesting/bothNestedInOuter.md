 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Outer_Target(extra = extra)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Outer_Target(extra = extra, property = value)
 * ```
 * 
 * 
 * @see Outer.Source
 * @see Outer.Target
 */
public fun  me.tbsten.cream.generated.Outer.Source.to_Outer_Target(
