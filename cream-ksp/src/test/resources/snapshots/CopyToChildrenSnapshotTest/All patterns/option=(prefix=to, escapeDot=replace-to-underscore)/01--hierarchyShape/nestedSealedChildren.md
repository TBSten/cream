 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Branch_Done(x = x)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Branch_Done(x = x, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_Source_Branch_Done(
    x: String,
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Branch_Pending(y = y)
 * ```
 * 
 * # Example: Override property values
 * 
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Branch_Pending(y = y, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_Source_Branch_Pending(
    y: Int,
