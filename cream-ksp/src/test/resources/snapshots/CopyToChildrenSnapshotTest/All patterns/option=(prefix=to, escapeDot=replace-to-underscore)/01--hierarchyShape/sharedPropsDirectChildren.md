 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Loading()
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Loading(property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Success(count = count)
 * ```
 * 
 * # Example: Override property values
 * 
 * ```kt
 * val source = Source(...)
 * val target = source.to_Source_Success(count = count, property = value)
 * ```
 * 
 * 
 * @see Source
