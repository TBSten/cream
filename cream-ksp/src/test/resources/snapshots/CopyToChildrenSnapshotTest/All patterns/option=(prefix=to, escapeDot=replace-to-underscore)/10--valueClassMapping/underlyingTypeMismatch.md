...
public sealed interface State {
  ...
  public class Loaded(
    ...
    override val id: Int = id.value.length
  }
}
 ...
 * ```kt
 * val source = State(...)
 * val target = source.to_State_Loaded(id = id)
 * ```
 * 
 ...
 * ```kt
 * val source = State(...)
 * val target = source.to_State_Loaded(id = id, property = value)
 * ```
 * 
 * 
 * @see State
 * @see State.Loaded
 */
public fun  me.tbsten.cream.generated.State.to_State_Loaded(
    id: DomainId,
