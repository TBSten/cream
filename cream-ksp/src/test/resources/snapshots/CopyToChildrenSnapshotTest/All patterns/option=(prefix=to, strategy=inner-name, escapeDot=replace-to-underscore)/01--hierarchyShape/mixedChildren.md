 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Branch_Leaf(b = b)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Branch_Leaf(b = b, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun  me.tbsten.cream.generated.Source.to_Branch_Leaf(
    b: Int,
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_ObjectChild()
 * ```
 * 
 * 
 * @see Source
 ...
 */
public fun me.tbsten.cream.generated.Source.to_ObjectChild() = me.tbsten.cream.generated.Source.ObjectChild
````
