 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Loading(a = a)
 * ```
 * 
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Loading(a = a, property = value)
 * ```
 * 
 * 
 * @see Source
 ...
 * ```kt
 * val source = Source(...)
 * val target = source.to_Success(a = a, b = b)
 * ```
 * 
 * # Example: Override property values
 * 
 * ```kt
 * val source = Source(...)
 * val target = source.to_Success(a = a, b = b, property = value)
 * ```
 * 
 * 
 * @see Source
