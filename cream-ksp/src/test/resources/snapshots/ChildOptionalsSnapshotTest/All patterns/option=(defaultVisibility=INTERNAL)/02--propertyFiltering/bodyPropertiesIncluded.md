 ...
 * (Auto generate by @[ChildOptionals] annotation of [Source])
 * 
 * Nullable accessor on [Source] exposing [Source.Success.note].
 * 
 * Returns the property value when `this` is such a child, otherwise `null`.
 * 
 * # Example
 ...
 * 
 * @see Source
 * @see Source.Success.note
 */
@Suppress("REDUNDANT_ELSE_IN_WHEN")
internal val me.tbsten.cream.generated.Source.note: String?
    get() = when (this) {
        is me.tbsten.cream.generated.Source.Success -> note
        else -> null
    }
````
