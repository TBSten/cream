...
```text
Invalid cream usage: @CopyTo on diag.Source produced an invalid function name "".
  funName template : ""
  target           : diag.Target
...
me.tbsten.cream.ksp.InvalidCreamUsageException: Invalid cream usage: @CopyTo on diag.Source produced an invalid function name "".
  funName template : ""
  target           : diag.Target
