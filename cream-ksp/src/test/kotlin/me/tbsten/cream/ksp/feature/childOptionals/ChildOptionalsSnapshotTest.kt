...
import me.tbsten.cream.ksp.feature.childOptionals.scenario.propertyNameScenarios
    ...
    FreeSpec({
        "All patterns" - {
            cartesian(
                ...
                // The accessors are properties, not functions, so the project naming options —
                // which compose function names — never reach them.
