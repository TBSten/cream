        ...
        .addAnnotation(
            AnnotationSpec
                ...
                .apply {
                    ...
                    if (funNameCode != null) addMember("%L = %L", CallFrom::funName.name, funNameCode)
                }.build(),
        ).build()

/** `funName = DefaultCopyFunctionName + "<[suffix]>"` を描画する式。 */
internal fun defaultCopyFunctionNamePlus(suffix: String): CodeBlock = CodeBlock.of("%M + %S", MemberName("me.tbsten.cream", "DefaultCopyFunctionName"), suffix)
