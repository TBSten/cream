...
internal fun sourceKindScenarios(): Generator<SnapshotScenario> =
    Generator.snapshotScenarios(
        ...
        "plainClassSource" to copyTo(clazz("Source", Prop("name")), dataClass("Target", Prop("name"), Prop("extra", INT))),
        "sealedInterfaceSource" to copyTo(sealedInterface("Source", "name"), dataClass("Target", Prop("name"), Prop("extra", INT))),
    )
